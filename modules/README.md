...
getScripts: function() {
	return [
		src, // will try to load it from the vendor folder, otherwise it will load is from the module folder.
		'moment.js', // this file is available in the vendor folder, so it doesn't need to be available in the module folder.
		this.file(src), // this file will be loaded straight from the module folder.
