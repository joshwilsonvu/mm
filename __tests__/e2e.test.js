  ...
  describe("MagicMirror source", () => {
    ...
    test("builds in production mode", async () => {
      ...
      expect(stripAnsi(stdout)).toMatchInlineSnapshot(`
        ...
        /Users/Josh/WebstormProjects/mm/MagicMirror/src/core/magic-mirror.tsx
        ERROR in /Users/Josh/WebstormProjects/mm/MagicMirror/src/core/magic-mirror.tsx(8,10):
        TS2305: Module '\\"../../../../../../../Users/Josh/WebstormProjects/mm/packages/utils/dist\\"' has no exported member 'NotificationProvider'."
      `);
